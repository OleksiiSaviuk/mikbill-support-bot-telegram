...
class API
{
    ...
    public function parse_onu_info(array $search, array $diag, string $client_mac): array
    {
        ...
        $onu = [
            ...
            'online_duration' => $this->stringOrNull($this->firstNotEmpty([
                $this->findByKeyRecursive($diagRoot, ['online_duration', 'online_time', 'up_time', 'uptime', 'last_reg_since', 'reg_since']),
